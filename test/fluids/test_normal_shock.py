...
class TestNormalShockLookup(unittest.TestCase):
    def test_m1(self):
        normal_shock=lookup_table(M1=3.0)
    ...
    def test_m2(self):
        normal_shock=lookup_table(M2=0.9805)
    ...
    def test_p21(self):
        normal_shock=lookup_table(p21=2916)
    ...
    def test_r21(self):
        normal_shock=lookup_table(r21=2.637)
    ...
    def test_t21(self):
        normal_shock=lookup_table(t21=2.0,gam=1.3)
    ...
    def test_p0201(self):
        normal_shock=lookup_table(p02_p01=0.6,gam=1.35)
    ...
    def test_p021(self):
        normal_shock=lookup_table(p02_p1=3.887,gam=1.35)
...
class TestMisc(unittest.TestCase):
    def test_entropy(self):
        ds = entropy_2(R=1716,p02_p01=.5615,s1=0.0)
